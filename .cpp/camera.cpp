...
#define TITLE_POSV_X 200.0f							// タイトルでのカメラ視点位置X
#define TITLE_POSV_Y 20.0f							// タイトルでのカメラ視点位置Y
#define TITLE_POSV_Z 650.0f							// タイトルでのカメラ視点位置Z
#define TITLE_POSR_X 0.0f							// タイトルでのカメラ注視点位置X
#define TITLE_POSR_Y 1.0f							// タイトルでのカメラ注視点位置Y
#define TITLE_POSR_Z 650.0f							// タイトルでのカメラ注視点位置Z
...
void CCamera::Update(void)
{
	...
	{	
		...
		if (m_pPlayer != NULL)
		{
			...
			bTitleFade = m_pPlayer->GetbTitleFade();	// タイトルフェード判定取得
		}
